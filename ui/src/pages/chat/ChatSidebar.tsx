...
export default function ChatSidebar({ open, onClose, chatEngine }: Props) {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-50 flex w-[17rem] flex-col border-r border-slate-100 bg-slate-50 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 ${
