...
exports.description = exports.update = exports.search = exports.getAll = exports.get = exports.duplicate = exports.delete = exports.create = void 0;
const create = __importStar(require("./create.operation"));
exports.create = create;
const deleteDeal = __importStar(require("./delete.operation"));
exports.delete = deleteDeal;
const duplicate = __importStar(require("./duplicate.operation"));
