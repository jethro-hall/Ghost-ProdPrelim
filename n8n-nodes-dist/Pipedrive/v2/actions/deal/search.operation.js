...
async function execute() {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            let responseData;
            if (returnAll) {
                responseData = await transport_1.pipedriveApiRequestAllItemsOffset.call(this, 'GET', '/deals/search', {}, qs);
            }
            else {
                responseData = await transport_1.pipedriveApiRequest.call(this, 'GET', '/deals/search', {}, qs, {
                    apiVersion: 'v1',
                });
            }
