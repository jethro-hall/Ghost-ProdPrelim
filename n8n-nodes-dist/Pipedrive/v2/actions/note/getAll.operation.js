    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                default: '',
                description: 'Filter notes by organization. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
            },
            {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            for (const key of Object.keys(filters)) {
                ...
                if (['pinned_to_deal_flag', 'pinned_to_person_flag', 'pinned_to_organization_flag'].includes(key)) {
            ...
            let responseData;
            if (returnAll) {
                responseData = await transport_1.pipedriveApiRequestAllItemsOffset.call(this, 'GET', '/notes', {}, qs);
            }
            else {
                responseData = await transport_1.pipedriveApiRequest.call(this, 'GET', '/notes', {}, qs, {
                    apiVersion: 'v1',
                });
            }
